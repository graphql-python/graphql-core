...
from graphql.validation.rules.no_unused_variables import (
...
def describe_validate_no_unused_variables():
    ...
    def uses_all_variables():
        expect_passes_rule(NoUnusedVariablesRule, """
    ...
    def variable_not_used():
        expect_fails_rule(NoUnusedVariablesRule, """
            query ($a: String, $b: String, $c: String) {
              field(a: $a, b: $b)
            }
        """, [
