...
def describe_visitor():
    ...
    def visits_kitchen_sink(kitchen_sink_query):  # noqa: F811
        ...
        assert visited == [
            ...
            ["enter", "string_value", "description", "operation_definition"],
            ...
            ["enter", "string_value", "description", "variable_definition"],
            ["leave", "string_value", "description", "variable_definition"],
            ...
            ["enter", "string_value", "description", "fragment_definition"],
            ["leave", "string_value", "description", "fragment_definition"],
